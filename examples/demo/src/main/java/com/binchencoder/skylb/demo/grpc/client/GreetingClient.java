...
public class GreetingClient {
  ...
  private static final GreetingConfig echoConfig = new GreetingConfig();

  private static ManagedChannel channel;
  private static DemoGrpc.DemoBlockingStub blockingStub;
  ...
  public GreetingClient() {
    ...
    blockingStub = DemoGrpc.newBlockingStub(channel);
  }
...
//      latch.countDown();
  ...
  private void echo() {
    LOGGER.info("Will try to grpc " + echoConfig.getEchoId() + "...");
...
class GreetingConfig extends AbstractConfig {
  ...
  @Parameter(names = {"--grpc-id", "-grpc-id"},
      description = "The param of invoke grpc server.", required = true)
  ...
  public String toKeyValues() {
    return new StringBuilder()
        .append("--grpc-id").append("=").append(this.getEchoId()).append("\n")
